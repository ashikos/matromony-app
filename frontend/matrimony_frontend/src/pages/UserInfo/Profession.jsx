    ...
    <div className='flex h-[90%] bg-white py-[2rem] p-[5rem] ' >
      ...
      <form onSubmit={handleSubmit} className="flex-col relative">
        ...
        <div class="mb-4 ">
          ...
          <input type="text" id="occupation" name="occupation" value={data.occupation} onChange={handleChange} class="block w-[30rem]  p-3 border border-gray-300 rounded-md focus:outline-none" />
        </div>
        ...
        <div class="mb-4 ">
          ...
          <input type="text" id="company" name="company" value={data.company} onChange={handleChange} class="block w-[30rem]  p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        ...
        <div class="mb-4 ">
          ...
          <input type="text" id="income" name="income" value={data.income} onChange={handleChange} class="block w-[30rem]  p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        ...
        <div class="mb-4 ">
          ...
          <input type="text" id="location" name="location" value={data.location}  onChange={handleChange} class="block w-[30rem]  p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
        ...
        <div class="mb-4 ">
          ...
          <input type="text" id="experience" name="experience" value={data.experience} onChange={handleChange} class="block w-[30rem]  p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500" />
        </div>
